...
export async function applyMigrations(options: { uri: string; logger: Logger; requireReplicaSet: boolean }): Promise<void> {
  const { uri, logger, requireReplicaSet } = options;
